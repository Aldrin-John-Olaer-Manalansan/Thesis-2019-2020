#define HOMEPACKAGE_TRANSCEIVER_PHYSICALCHANNEL 28 // value must be within 0-125 ~ DEFAULT: 76
//
...
#define TRANSCEIVER_REQUEST_GETRELAYSTATEANDPOWERCONSUMPTION 4
#define TRANSCEIVER_REQUEST_GETWIFICREDENTIALS 5
#define TRANSCEIVER_REQUEST_GETWIFILOSTPACKET 6
#define TRANSCEIVER_REQUEST_GETIPADDRESS 7
...
#define TRANSCEIVER_COMMAND_SMARTSOCKET_RELAYSTATEANDPOWERCONSUMPTION 4
#define TRANSCEIVER_COMMAND_IPCAMERA_WIFICREDENTIALS 5
#define TRANSCEIVER_COMMAND_IPCAMERA_IPADDRESS 6
