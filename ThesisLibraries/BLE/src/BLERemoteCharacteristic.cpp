...
std::string BLERemoteCharacteristic::readValue() {
	...
	m_semaphoreReadCharEvt.take(5000,"readValue");
	...
	m_semaphoreReadCharEvt.wait("readValue",10000/portTICK_PERIOD_MS);
...
void BLERemoteCharacteristic::registerForNotify(notify_callback notifyCallback, bool notifications) {
	...
	m_semaphoreRegForNotifyEvt.take(5000,"registerForNotify");
	...
	m_semaphoreRegForNotifyEvt.wait("registerForNotify",10000/portTICK_PERIOD_MS);
...
void BLERemoteCharacteristic::writeValue(uint8_t* data, size_t length, bool response) {
	...
	m_semaphoreWriteCharEvt.take(5000,"writeValue");
	...
	m_semaphoreWriteCharEvt.wait("writeValue",10000/portTICK_PERIOD_MS);
